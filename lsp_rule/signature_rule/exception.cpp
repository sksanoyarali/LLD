...
// noexcept(false) is the default behaviour 
// it show the function is allowed 
// to throw exeception
// Why explicitly write noexcept(false)?

// Mainly for inheritance correctness.

// Rule:

// A derived class cannot throw more than the base class promises
class Parent {
public:
